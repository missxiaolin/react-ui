...
import DownOutlined from '../icon/default/DownOutlined'
import LeftOutlined from '../icon/default/LeftOutlined'
import UpOutlined from '../icon/default/UpOutlined'
import RightOutlined from '../icon/default/RightOutlined'
    ...
    return (
        ...
        >
            ...
            {startCollapsible && (
                ...
                >
                    <StartIcon className={classNames(`${splitBarPrefixCls}-collapse-icon`, `${splitBarPrefixCls}-collapse-start`)} />
                </div>
            )}
            ...
            {endCollapsible && (
                ...
                >
                    <EndIcon className={classNames(`${splitBarPrefixCls}-collapse-icon`, `${splitBarPrefixCls}-collapse-end`)} />
                </div>
            )}
        </div>
    )
