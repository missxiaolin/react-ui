...
const App: React.FC = () => {
    ...
    return (
        <div>
            ...
            {showTest && <Watermark fullPage={true} font-color="#fa2c19" content="l-ui" />}
            {showImg && <Watermark image={img} content="" imageWidth={50} imageHeight={50} zIndex={1}></Watermark>}
        </div>
    )
}
