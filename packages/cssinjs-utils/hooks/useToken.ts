import type { Theme, TokenType } from '@l/cssinjs'
...
export type UseToken<CompTokenMap extends TokenMap, DesignToken extends TokenType, AliasToken extends TokenType> = () => UseTokenReturn<
    CompTokenMap,
    DesignToken,
    AliasToken
>
